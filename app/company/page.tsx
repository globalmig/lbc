        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6">
          ...
          <div className="break-keep space-y-8 md:space-y-10 text-white/90">
            <p>
              ...
              <br /> 저희 ㈜엘비씨는 수용성 운모(MICA)규산을 오랜기간 연구 끝에 개발한 획기적인 광물질로서 관련업계에서는 하나같이 상식을 깰 놀라운 발명이라고 극찬할 정도로 기존의 마인드를
              뒤바꾸어놓은 일종의 무해한 친환경 복합성 미네랄입니다. <br />
              저희 ㈜엘비씨는 이처럼 각고의 노력 끝에 국내에서는 세계최초로 발명해 낸 수용성규산 응용제품을 판매 하고 있으며, 기존의 규산제품과는 월등한 차이점을 가지고있습니다. 또한 물에 녹는 수용성
              운모(MICA)규산을 활용한 방법이 새로운 친환경 농법으로 F.T.A 위기를 극복 할 수 있는 대안으로 부각되고 있습니다. <br />
              <br />
              주식회사 엘비씨는 미래를 이용한 환경과 동식물을 복원개선 하는 제품을 출시하였습니다. <br />
              기존의 규산제품들은 물에 녹지 않는 불용성, 가용성의 단점을 가지고 있었습니다. 반면 수용성 운모(MICA)규산은 1,650℃ 이상의 용광로에서 8시간 이상 특수한 방법으로 가열하여 불순물을 제거하고
              농작물에 유익한 미량원소는 그대로 살려 물에 잘 녹게끔 제조된 천연 광물질로서 기존의 규산제품과는 차별화 하였습니다. <br />
              <br />
