...
export default function Contact() {
  return (
    <div className="min-h-[400px] w-full h-full flex flex-col justify-center items-start bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: 'url("/img/bg_contact.jpg")' }}>
